...
# ─────────────────────
# 📌 [1] 영역별 자동 학습 가이드 문구 (여기!)
# ─────────────────────
learning_guides = {
    "기초역량": "컴퓨터 기본 조작, 파일 관리, 온라인 학습 도구 활용에 대한 기초 보완 학습이 필요합니다.",
    "전공이해": "전공 핵심 개념과 용어 이해를 중심으로 단계별 실습 학습을 권장합니다.",
    "학습태도": "출결 관리 및 과제 수행 중심으로 학습 태도 개선이 필요합니다.",
    "취업인식": "직무 탐색과 진로 목표 설정 활동이 필요합니다."
}

# ─────────────────────
# 세션 초기화
# ─────────────────────
for key in ["submitted", "wrong_df", "analysis", "score", "total_rate",
            "df_all", "class_no", "guide_text"]:
